...
from onmt.utils.misc import generate_relative_positions_matrix,\
                            relative_matmul
from onmt.modules.sparse_activations import Sparsemax, EvSoftmax, Tsallis15
...
class MultiHeadedAttention(nn.Module):
    ...
    def __init__(self, head_count, model_dim, normalizer="softmax", dropout=0.1,
        ...
        if normalizer == "softmax":
            ...
            raise ValueError(f"Normalizer '{normalizer}' is not supported.")
    ...
    def forward(self, key, value, query, mask=None,
        ...
        attn = self.normalizer(scores).to(query.dtype)
