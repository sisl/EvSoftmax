...
from onmt.modules.sparse_activations import sparsemax, tsallis15, evsoftmax
...
class GlobalAttention(nn.Module):
    ...
    * Bahdanau Attention (mlp):
    ...
    Args:
       ...
       attn_func (str): attention function to use, options
          [softmax,sparsemax,evsoftmax,tsallis15]
    ...
    def __init__(self, dim, coverage=False, attn_type="dot",
        ...
        assert attn_func in [
            "softmax", "sparsemax", "tsallis15", "evsoftmax"], (
    ...
    def forward(self, source, memory_bank, memory_lengths=None, coverage=None):
        ...
        elif self.attn_func == "evsoftmax":
            align_vectors = evsoftmax(align.view(batch*target_l, source_l), -1)
        else:
