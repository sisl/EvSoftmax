...
class TransformerDecoderLayerBase(nn.Module):
    def __init__(
        ...
        Args:
            ...
            self_attn_function (string): function for normalizing self-attention.
                softmax, evsoftmax, sparsemax, tsallis15
...
class TransformerDecoderLayer(TransformerDecoderLayerBase):
    ...
    def __init__(
        ...
        self.context_attn = MultiHeadedAttention(
            heads, d_model, normalizer=self_attn_function, dropout=attention_dropout
        )
        ...
        self.transformer_layers = nn.ModuleList(
            [
                TransformerDecoderLayer(
                    ...
                    dropout,
                    attention_dropout,
                    self_attn_function=self_attn_function,
...
class TransformerLMDecoder(TransformerDecoderBase):
    ...
    Args:
        ...
        d_ff (int): size of the inner FF layer
        copy_attn (bool): if using a separate copy attention
        self_attn_function (str): function for self-attention softmax, sparsemax,
            evsoftmax, tsallis15
        self_attn_type (str): type of self-attention scaled-dot, average
        dropout (float): dropout in residual, self-attn(dot) and feed-forward
        attention_dropout (float): dropout in context_attn (and self-attn(avg))
